...
const NewThisWeek = (_) => {
  ...
  const data = [
    ...
    "History",
    "Wellness",
    "Olympains&Paralypians",
    "Designed for aceessibility",
  ];
    ...
    <>
      <Box className="middleResponsive" maxWidth="false">
        <Container
          ...
          maxWidth="false"
          sx={{ width: "auto", marginLeft: 10, marginTop: 5, marginRight: 10 }}
        >
          <Stack className="app2">
            <Stack justifyContent="space-between" direction="row">
              <Typography
                className="imagecontainersubtext"
                fontSize={35}
                fontWeight="600"
              >
                New this Week
              ...
              >
                {scrollX2 !== 0 && (
                  <button className="prev2 hover" onClick={() => slide2(-550)}>
                    <FontAwesomeIcon
                ...
                {!scrolEnd2 && (
                  <button className="next2 hover" onClick={() => slide2(+550)}>
                    <FontAwesomeIcon
                      style={{ fontSize: 15, padding: 6 }}
                      icon={faAngleRight}
                    />
        ...
        >
          <ImageList
            className="imagesubcontainer"
            ref={scrl2}
            onScroll={scrollCheck2}
            style={{ overflow: "hidden", paddingLeft: 100, marginTop: 5 }}
            cols={3}
            columnWidth={500}
            rowHeight="450"
          >
            {itemData.map((item) => (
              ...
              >
                ...
                <ImageListItemBar
                  ...
                  title={
                    <Typography fontSize={30} flexWrap="wrap">
                      {item.about}
                    </Typography>
                  }
                  position="top"
        ...
        <Container
          ...
          maxWidth="false"
          style={{ marginLeft: 85, width: "auto", marginRight: 100 }}
        >
          <div className="App">
            <Stack
              className="chips"
            ...
            <div className="chipscrollcontainer">
              {scrollX !== 0 && (
                <button className="prev hover" onClick={() => slide(-50)}>
                  <FontAwesomeIcon
                    style={{ fontSize: 15, padding: 6 }}
                    icon={faAngleLeft}
                  />
              ...
              {!scrolEnd && (
                <button className="next hover" onClick={() => slide(+50)}>
                  <FontAwesomeIcon
                    style={{ fontSize: 15, padding: 6 }}
                    icon={faAngleRight}
                  />
